...
public class TelaContatoPanel extends JPanel {
    ...
    private void criarFormulario() {
        ...
        formPanel.setBorder(BorderFactory.createTitledBorder("Cadastro de Contatos"));
    ...
    private void salvar() {
        if (txtTelefone.getText().isBlank() || txtEmail.getText().isBlank() || txtEndereco.getText().isBlank()) {
    ...
    private void preencherFormulario() {
        ...
        if (row >= 0) {
            ...
            String telefone = tableModel.getValueAt(row, 1).toString();
            txtTelefone.setText(telefone.replaceAll("[^0-9]", ""));

            txtEmail.setText(tableModel.getValueAt(row, 2).toString());
            txtEndereco.setText(tableModel.getValueAt(row, 3).toString());
        }
    }
