            ...
            protected void done() {
                try {
                    ...
                    if (response != null) {
                        ...
                        limparFormulario();
                        atualizarTabela(); // 🔹 garante refresh imediato
                    } else {
                        JOptionPane.showMessageDialog(TelaEstoquePanel.this, "Erro ao salvar estoque (resposta nula).", "Erro", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (Exception e) {
